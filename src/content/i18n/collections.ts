...
const collections = {
  en: {
    ...
    voluntarySkills: [
      { label: "Software development", included: true },
      { label: "Websites", included: true },
      { label: "Automation", included: true },
      { label: "Programming", included: true },
      { label: "Databases", included: true },
      { label: "Data processing", included: true },
      { label: "Interfaces (APIs)", included: true },
      { label: "Linux computers", included: true },
      { label: "Digital maps (Maps, OSM)", included: true },
      { label: "Windows computers", included: false },
      { label: "Apple devices (MacOS, iPhone)", included: false },
      { label: "Microsoft Office (Word, Excel)", included: false },
    ],
  },
  de: {
    footer: {
    ...
    voluntarySkills: [
      { label: "Software-Entwicklung", included: true },
      { label: "Webseiten", included: true },
      { label: "Automatisierung", included: true },
      { label: "Programmierung", included: true },
      { label: "Datenbanken", included: true },
      { label: "Datenverarbeitung", included: true },
      { label: "Schnittstellen (APIs)", included: true },
      { label: "Linux Computer", included: true },
      { label: "Digitale Karten (Maps, OSM)", included: true },
      { label: "Windows Computer", included: false },
      { label: "Apple Geräte (MacOS, iPhone)", included: false },
      { label: "Microsoft Office (Word, Excel)", included: false },
    ],
  },
}
