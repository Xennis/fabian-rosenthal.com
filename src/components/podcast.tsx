    ...
    <section className="pt-10 md:pt-12">
      ...
      <div className="pt-2 sm:flex sm:gap-6">
        ...
        <div className="pt-4 sm:pt-0">
          <p className="leading-7">{podcast.description}</p>
          <ul
            aria-label={`Plattformen, auf denen ${podcast.name} verfügbar ist`}
            className="flex items-center gap-4 pt-4"
          >
            {podcast.platforms.map((p, i) => (
              <li key={i}>
