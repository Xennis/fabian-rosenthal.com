    ...
    <div class="flex space-x-3">
        ...
        ${[0, 1, 2, 3, 4]
          .map(
            (
              rating,
            ) => `<svg class="w-4 h-4 ${props.rating !== null && props.rating > rating ? "text-yellow-300" : "text-gray-300"}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
